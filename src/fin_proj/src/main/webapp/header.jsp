...
<header>
<nav class="navbar">
    <h1 class="navbar_logo"><a href="toMain.do"><img class="logo" src="img/logo.png"></a></h1>
    <!-- 검색창 -->
      ...
      <% if(session.getAttribute("userName")==null){  %>
      		<li class="nav_item"><a href="login.me"><img class="pictogram" src="img/signin.png"></a></li> 
      		<% }else{ %>
