...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-iYQeCzEYFbKjA/T2uDLTpkwGzCiq6soy8tYaI1GyVh/UjpbCx/TYkiZhlZB6+fzT" crossorigin="anonymous">	
	...
	<center>
		...
		<table border="1" cellpadding="0" cellspacing="0" width="800" class="table table-striped table-sm text-center">
			<tr>
				<th bgcolor="orange" width="200">dc_pcno</th>
				<th bgcolor="orange" width="150">dc_name</th>
				<th bgcolor="orange" width="150">dc_desc</th>
			</tr>
			...
			<tr>
				...
				<td align="center">${divisionCode.dc_desc}</td>
