...
<body>
	...
	<form name="#" class="mjoin_form form" action="productinsert.do" method="post" enctype="multipart/form-data">
...
<tr>
							...
							<tr>
								...
								<th class="ess"><span class="tit">카테고리 번호</span></th>
								<td><input type="text" name="g_cno" class="m_join_repw"
									placeholder="" autocomplete="">
									<div class="tip_txt ">카테고리 입력해주세요.</div></td>
							</tr>
