...
<body>
	...
	<form name="userInfo" class="mjoin_form form"
		action="insertUserMember.do" onsubmit="return checkValue()"
		method="post">
						...
						<tbody>
							<tr>
								...
								<td colspan="3">
									...
									<div class="tip_txt ">영문, 숫자로 6자 이상 입력해주세요.</div>
								</td>
							</tr>
							<tr>
								...
								<td><input type="password" id="join_repw"
									name="join_repw" class="m_join_repw" placeholder=""
									autocomplete="new-password" onchange="check_pw()">
									&nbsp;
							...
							<tr>
								...
								<td>
									<div class="input_box">
										<input type="text" name="um_ars" value="" class="m_join_name"
											placeholder="" style="width: 120px">
										<div class="tip_txt if_beside">실명을 입력해주세요.</div>
									</div>
								</td>
								<th><span class="tit">생년월일</span></th>
								<td><input type="text" name="um_ymd" class="m_join_birth"
									value="" placeholder="예)19900101" style="width: 120px"></td>
							</tr>
							<tr>
								<th><span class="tit">성별</span></th>
								<td><label class="label_design"><input type="radio"
										name="um_gender" value="M" class="m_join_sex"><span
								...
								<td>
									...
									<div class="input_full">
										<input type="text" name="addr1"
											id="sample6_address" placeholder="주소" class="input_design"
											readonly="readonly"> <input type="text" name="addr2"
											id="sample6_extraAddress" placeholder="참고항목"
											readonly="readonly" class="input_design"> <input
