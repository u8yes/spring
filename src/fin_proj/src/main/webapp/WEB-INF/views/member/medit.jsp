...
<form name="from" class="mjoin_form form" action="updateMember.do" method="post">
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="password" name="um_password" class="m_join_pw" value="" placeholder="" autocomplete="new-password">
								<div class="tip_txt ">
	...
	<br>
			...
			<div class="mjoin_btnbox ">
				<ul>
					...
					<li><input type="submit" value="비밀번호변경하기">
					<li><a href="mlist.do" class="submitbutton" >가입완료</a></li>
					<li><a href = "mdelete.do">회원탈퇴</a>
				</ul>
			</div>
			<!-- /정보입력 -->
		</div>
