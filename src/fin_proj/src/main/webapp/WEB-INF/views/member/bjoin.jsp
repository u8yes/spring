...
<form name="from" class="mjoin_form form" action="insertBrandMember.do" method="post">
...
<br>
			...
			<div class="m_form">
				<table>
					...
					<tbody>
						<tr>
							<th class="ess"><span class="tit" >기업아이디</span></th>
							<td colspan="3">
								<div class="input_box">
									<input type="text" name="bm_id" class="m_join_id" placeholder="" style="width:200px">
									<a href="#none" class="checkbutton">기업아이디 중복체크</a>
						...
						<tr>
							<th class="ess"><span class="tit">기업 매니저이름</span></th>
                            <td>
                                <div class="input_box">
                                     <input type="text" name="bm_manager"  class="m_join_name" placeholder="" style="width:120px" >
                            ...
                            <td>
                                <div class="input_box">
                                        <input type="text" name="bm_tel" class="m_join_tel" placeholder="휴대폰 번호" style="width:180px" >
						...
						<tr>
							...
							<td colspan="3">
								<div class="input_box mail">
									<input type="text" name="bm_email" class="input_design js_email_prefix" placeholder="이메일 아이디" style="width:150px">
	...
	<br>
			...
			<div class="mjoin_btnbox ">
				<ul>
					...
					<li><a href="blist.do" class="submitbutton" >가입완료</a></li>
				</ul>
			</div>
			<!-- /정보입력 -->
		</div>
