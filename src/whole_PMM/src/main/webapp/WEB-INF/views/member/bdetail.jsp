...
<form name="from" class="mjoin_form form" action="updateBrandMember2.do" method="post">
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="password" name="bm_password" class="m_join_pw" value="${brandmember.bm_password}" placeholder="" autocomplete="new-password">
								<div class="tip_txt ">
	...
	<br>
			...
			<div class="mjoin_btnbox ">
				<ul>
					...
					<li><a href = "bdelete.do?bm_no=${brandmember.bm_no}">회원탈퇴</a></li>
