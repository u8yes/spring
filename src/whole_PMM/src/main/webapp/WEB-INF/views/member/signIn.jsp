  ...
  <div class= "signintop">
	<div class= "usersignin">
		...
		<form action="login.me" method="post">
    		...
    		<button id="kakaosignIn" class="signinbutton" type="submit">카카오로그인</button>
  			<br>
    		<button id="singUp" class="signinbutton"  type="button" onclick= "location.href='insertUserMember.do'">회원가입</button>
   			<br>
	...
	<div class= "usersignin">
		...
		<form action="blogin.me" method="post">
			...
			<br>
    		<input id="signIn" class="signinbutton" type="submit" value="로그인">
    		<br>
    		<button id="singUp" class="signinbutton"  type="button" onclick= "location.href='insertBrandMember.do'">입점문의</button>
   			<br>
