...
<form name="from" class="mjoin_form form" action="updateMember2.do" method="post">
...
<br>
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td colspan="3">
								<div class="input_box">
									<input type="text" name="um_mid" class="m_join_id" placeholder="" value="${member.um_mid}" style="width:200px">
						...
						<tr>
							...
							<td>
								<input type="password" name="um_password" class="m_join_pw" value="${member.um_password}" placeholder="" autocomplete="new-password">
								<div class="tip_txt ">
						...
						<tr>
                            ...
                            <td>
                                <div class="input_box">
                                     <input type="text" name="um_ars" value="${member.um_ars}" class="m_join_name" value="${member.um_ars}" placeholder="" style="width:120px" >
                                     <div class="tip_txt if_beside">실명을 입력해주세요.</div>
                                </div>
                            	</td>
							          <th><span class="tit">생년월일</span></th>
                                <td>
                                      <input type="text" name="um_ymd" class="m_join_birth" value="${member.um_ymd}" placeholder="" style="width:120px" >
                                </td>
                            	</tr>
								<tr>
								      <th><span class="tit">성별</span></th>
                                <td >
                                      <label class="label_design"><input type="radio" name="um_gender" value="M"  class="m_join_sex" checked><span class="txt">남성</span></label>
                                      <label class="label_design"><input type="radio" name="um_gender" value="F"  class="m_join_sex"><span class="txt">여성</span></label>
                                </td>
                                	<th><span class="tit">전화번호</span></th>
									<td>
										<input type="text" name="um_tel" class="m_join_hometel" placeholder="전화번호" value="${member.um_tel}" style="width:180px">
                            ...
                            <td>
                                <div class="input_box">
                                        <input type="text" name="join_tel2" class="m_join_tel" placeholder="휴대폰 번호" style="width:180px" >
							...
							<td>
								<label class="label_design"><input type="radio" name="um_snsch" value=1 checked=""><span class="txt">수신</span></label>
								<label class="label_design"><input type="radio" name="um_snsch" value=2><span class="txt">수신거부</span></label>
						...
						<tr>
							...
							<td colspan="3">
								<div class="input_box mail">
									<input type="text" name="um_email" value="${member.um_email}" class="input_design js_email_prefix" placeholder="이메일 아이디" style="width:150px">
						...
						<tr>
							...
							<td colspan="3">
								<label class="label_design"><input type="radio" name="um_emailch" value=1 checked=""><span class="txt">수신</span></label>
								<label class="label_design"><input type="radio" name="um_emailch" value=2><span class="txt">수신거부</span></label>
						...
						<tr>
								...
								<td>
									...
									<div class="input_full">
										...
										<input type="text" name="um_addr" value="${member.um_addr}" id="_addr2" class="input_design" placeholder="나머지 주소">
									</div>
								</td>
	...
	<br>
			...
			<div class="mjoin_btnbox ">
				<ul>
					...
					<li><a href = "mdelete.do?um_no=${member.um_no}">회원탈퇴</a></li>
	...
	<!-- /공통페이지 섹션 -->
	<input type="hidden" name="um_no" value="${member.um_no}">
